...
@parallel function SwapRes!( dVxdτ::Data.Array, dVydτ::Data.Array, dPfdτ::Data.Array, Res_Vx::Data.Array, Res_Vy::Data.Array, Res_Pf::Data.Array )
    @all(dVxdτ) =  @all(Res_Vx)
    @all(dVydτ) =  @all(Res_Vy)
    @all(dPfdτ) =  @all(Res_Pf)
    return
end
...
@parallel function compute_6!(Pf::Data.Array, Rho_X_ϕ::Data.Array, Res_Phi::Data.Array, Phi::Data.Array, Res_Pf::Data.Array, Rho_s::Data.Array, X_s::Data.Array, Phi_old::Data.Array, Rho_X_old::Data.Array, ∇V_ρ_X::Data.Array, dPfdτ::Data.Array, dampPf::Data.Number, dt_Pf::Data.Number, dtp::Data.Number)
...
@parallel function compute_7!(Eta::Data.Array, Lam::Data.Array, ∇V::Data.Array, ε_xx::Data.Array, ε_yy::Data.Array, ε_xy::Data.Array, Ptot::Data.Array, Vx::Data.Array, Vy::Data.Array, Phi::Data.Array, Ptot_old::Data.Array, Pf::Data.Array, Pf_old::Data.Array, RPt::Data.Array,
    ...
    @all(RPt)  = @all(Ptot) - (@all(Ptot_old)-dtp*( K_d*@all(∇V) - α*( (@all(Pf) - @all(Pf_old))/dtp ) - K_d*@all(Pf) / ((1.0-@all(Phi))*@all(Lam)) )) / ( 1.0 + dtp*K_d/((1.0-@all(Phi))*@all(Lam)) )
    @all(Ptot) = @all(Ptot) - dtPt*@all(RPt)
    return 
end
...
@parallel function compute_10!(Vx::Data.Array, Vy::Data.Array, Res_Vx::Data.Array, Res_Vy::Data.Array, dVxdτ::Data.Array, dVydτ::Data.Array, dampV::Data.Number, dt_Stokes::Data.Number)
...
@parallel function postproc!(drhoT_dt::Data.Array, drhosphi_dt::Data.Array, drhofphi_dt::Data.Array, drhoXphi_dt::Data.Array, dpf_dt::Data.Array, dp_dt::Data.Array, dphi_dt::Data.Array, drhos_dt::Data.Array, Rho_s::Data.Array, Rho_f::Data.Array, X_s::Data.Array, Phi::Data.Array, Rho_s_old::Data.Array, Rho_f_old::Data.Array, Rho_X_old::Data.Array, Phi_old::Data.Array, Rho_t::Data.Array, Rho_t_old::Data.Array, Pf::Data.Array, Pf_old::Data.Array, Ptot::Data.Array, Ptot_old::Data.Array, dtp::Data.Number)
    ...
    @all(dp_dt)         = (@all(Ptot)                          - @all(Ptot_old))                      /dtp
...
@views function PT_HMC()
    ...
    σ_y             = 135.0*Pini_Pappl*1e6 # yield stress
    ...
    while timeP < time_tot
    	...
    	while err_M>tol && it_tstep<itmax
            ...
            # Porosity evolution
            @parallel compute_6!(Pf, Rho_X_ϕ, Res_Phi, Phi, Res_Pf, Rho_s, X_s, Phi_old, Rho_X_old, ∇V_ρ_X, dPfdτ, dampPf, dt_Pf, dtp)
            ...
            @parallel compute_7!(Eta, Lam, ∇V, ε_xx, ε_yy, ε_xy, Ptot, Vx, Vy, Phi, Ptot_old, Pf, Pf_old, Res_Pt, dt_Pt, η_m, ϕ_exp, ϕ_ini, λ_η, dtp, K_d, α, dx, dy)
            ...
            @parallel compute_10!(Vx, Vy, Res_Vx, Res_Vy, dVxdτ, dVydτ, dampV, dt_Stokes)
        ...
        @parallel postproc!(drhoT_dt, drhosphi_dt, drhofphi_dt, drhoXphi_dt, dpf_dt, dp_dt, dphi_dt, drhos_dt, Rho_s, Rho_f, X_s, Phi, Rho_s_old, Rho_f_old, Rho_X_old, Phi_old, Rho_t, Rho_t_old, Pf, Pf_old, Ptot, Ptot_old, dtp)
